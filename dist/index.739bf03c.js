...
parcelHelpers.export(exports, "divPictEl", ()=>divPictEl);
parcelHelpers.export(exports, "divDescEl", ()=>divDescEl);
parcelHelpers.export(exports, "loaderEl", ()=>loaderEl);
var _catApi = require("./cat-api");
var _renderBreedDesc = require("./renderBreedDesc");
var _fetchAndRenderBreeds = require("./fetchAndRenderBreeds");
...
(0, _fetchAndRenderBreeds.fetchAndRenderBreeds)();
...
function onChangeSelect(event) {
    ...
    (0, _catApi.fetchCatByBreed)(breedId).then((breed)=>(0, _renderBreedDesc.renderBreedDesc)(breed))// .then(breed => console.log(breed))
    .catch((error)=>{
        console.log(error);
...
},{"./cat-api":"5IWAT","./renderBreedDesc":"6klvA","./fetchAndRenderBreeds":"15kcj","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5IWAT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const fetchBreeds = ()=>{
    return (0, _axiosDefault.default).get(`${BASE_URL}/breeds?api_key=${KEY}`).then((response)=>{
...
const fetchCatByBreed = (breedId)=>{
    return (0, _axiosDefault.default).get(`${BASE_URL}/images/${breedId}?api_key=${KEY}`).then((response)=>{
        return response.data;
    }).catch((error)=>{
        throw new Error(error);
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6klvA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderBreedDesc", ()=>renderBreedDesc);
...
const renderBreedDesc = (breed)=>{
    ...
    (0, _index.divPictEl).insertAdjacentHTML("beforeend", markupPicture);
    (0, _index.divDescEl).insertAdjacentHTML("beforeend", markupDescript);
};

},{"./index":"ebWYT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"15kcj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchAndRenderBreeds", ()=>fetchAndRenderBreeds);
var _index = require("./index");
var _catApi = require("./cat-api");
var _renderBreedsSelect = require("./renderBreedsSelect");
...
const fetchAndRenderBreeds = ()=>{
    (0, _index.loaderEl).classList.remove("unvisible");
    (0, _catApi.fetchBreeds)()// .then(breeds => console.log(breeds))
    .then((breeds)=>(0, _renderBreedsSelect.renderBreedsSelect)(breeds)).catch((error)=>{
        console.log(error);
        Notiflix.Notify.failure("Oops! Something went wrong! Try reloading the page!");
    }).finally(()=>{
        (0, _index.loaderEl).classList.add("unvisible");
        (0, _index.breedSelect).classList.remove("unvisible");
    });
};

},{"./index":"ebWYT","./cat-api":"5IWAT","./renderBreedsSelect":"jvJW6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jvJW6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderBreedsSelect", ()=>renderBreedsSelect);
var _index = require("./index");
...
const renderBreedsSelect = (breeds)=>{
    ...
    (0, _index.breedSelect).insertAdjacentHTML("beforeend", markup);
...
},{"./index":"ebWYT","slim-select":"lzHUr","slim-select/dist/slimselect.css":"6O4cs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lzHUr":[function(require,module,exports) {
...
},{}],"6O4cs":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
